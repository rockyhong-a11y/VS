...
// ─── CHARACTERS ─────────────────────────────────────────────
// spriteId = img/chars/{spriteId}_sheet.png 로 로드
const CHARACTERS = {
  pokerou: {
    id: 'pokerou', spriteId: 'pokerou',
  ...
  mari: {
    id: 'mari', spriteId: 'mari',
    name: '마리', subtitle: '룬 추적자 🔷',
    color: '#e8b8c4',
    colorAlpha: 'rgba(232,184,196,0.2)', colorShadow: 'rgba(232,184,196,0.5)',
    hp: 90, speed: 104, hpRegen: 0.05,
  ...
  fenrir: {
    id: 'fenrir', spriteId: 'fenrir',
    name: '펜리르', subtitle: '뼈술사 🦴',
    color: '#aabbdd',
    colorAlpha: 'rgba(170,187,221,0.2)', colorShadow: 'rgba(170,187,221,0.5)',
  ...
  sowan: {
    id: 'sowan', spriteId: 'sowan',
    name: '소완', subtitle: '성십자사 ✝️',
    color: '#4488cc',
  ...
  death: {
    id: 'death', spriteId: 'death',
    name: '데스', subtitle: '사신 💀',
    color: '#cc44ff',
    colorAlpha: 'rgba(204,68,255,0.2)', colorShadow: 'rgba(204,68,255,0.5)',
    hp: 80, speed: 120, hpRegen: 0.12,
    startWeapon: 'magicOrb', passive: { aoeMult: 1.5, atkMult: 1.3 },
    description: '공전하는 사신의 구체\n패시브: 범위+공격력 대폭 강화',
